use super::{sampler::Sampler, PlaysNotesEventTracker, Synthesizer, VoicePerNoteStore};
...
use groove_core::{
    ...
    traits::{
        Controllable, Generates, HasUid, IsInstrument, IsStereoSampleVoice, PlaysNotes, Resets,
        Ticks,
    },
    StereoSample,
};
